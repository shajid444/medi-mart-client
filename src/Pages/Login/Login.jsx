    ...
    return (
        <div className='lg:flex  justify-center pt-40 items-center'>
            ...
            <div className='rounded-lg '>
                <img className='rounded-lg' src="https://images.unsplash.com/photo-1432821596592-e2c18b78144f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bG9naW58ZW58MHx8MHx8fDA%3D" alt="" />
