      ...
      <div className="navbar-end z-50 ">
          {
              user ? <div className="dropdown dropdown-end " >
                  ...
                  <ul tabIndex={0} className="menu menu-sm dropdown-content  z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                      ...
                      <li>
                          <Link to='/' className="btn btn-sm btn-ghost"> My added food items </Link>
                      </li>
                      <li>
                          <Link to ='/' className="btn btn-sm btn-ghost">Add a food item </Link>
                      </li>
                      <li>
                          <Link to='/' className="btn btn-sm btn-ghost">My ordered food items </Link>
                      </li>
